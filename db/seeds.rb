...
stops = Stop.create([
  { name: "Taqueria Cancun", description: "Heavily rice based, arguably SF's best burrito.", latitude: 37.760457, longitude: -122.419576, stop_length: 30 },
  ...
  { name: "La Taqueria", description: "Known for its tacos and carnita burritos", latitude: 37.750880, longitude: -122.418122, stop_length: 45 },
